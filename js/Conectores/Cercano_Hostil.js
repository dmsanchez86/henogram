;(function() {
    ...
    var Cercano_Hostil = function(params) {
        params = params || {};
        var _super =  jsPlumb.Connectors.AbstractConnector.apply(this, arguments);
        this.type = "Cercano_Hostil";
    ...
    jsPlumbUtil.extend(Cercano_Hostil, jsPlumb.Connectors.AbstractConnector);
    jsPlumb.registerConnectorType(Cercano_Hostil, "Cercano_Hostil");
})();
