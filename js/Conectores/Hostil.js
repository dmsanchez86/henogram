;(function() {
    ...
    var Hostil = function(params) {
        params = params || {};
        var _super =  jsPlumb.Connectors.AbstractConnector.apply(this, arguments);
        this.type = "Hostil";

        var wavelength = params.wavelength || 20,
            amplitude = params.amplitude || 8,
    ...
    jsPlumbUtil.extend(Hostil, jsPlumb.Connectors.AbstractConnector);
    jsPlumb.registerConnectorType(Hostil, "Hostil");
})();
