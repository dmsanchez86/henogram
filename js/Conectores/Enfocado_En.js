;(function() {
    ...
    var Enfocado_En = function(params) {
        params = params || {};
        var _super =  jsPlumb.Connectors.AbstractConnector.apply(this, arguments);
        this.type = "Enfocado_En";
    ...
    jsPlumbUtil.extend(Enfocado_En, jsPlumb.Connectors.AbstractConnector);
    jsPlumb.registerConnectorType(Enfocado_En, "Enfocado_En");
})();
